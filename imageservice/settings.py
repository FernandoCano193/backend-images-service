...
#ALLOWED_HOSTS = ['progamacionweb.ddns.net','3.237.46.228']
ALLOWED_HOSTS = ['progamacionweb.ddns.net']
#CORS_ALLOWED_ORIGINS = ['http://34.239.173.70:8080']
#CSRF_TRUSTED_ORIGINS = ['http://34.239.173.70t:8080']
CORS_ALLOWED_ORIGINS = ['http://progamacionweb.ddns.net:8080']
CSRF_TRUSTED_ORIGINS = ['http://progamacionweb.ddns.net:8080']
...
'default': {
        ...
        "NAME": "django",
        "USER": "django",
        "PASSWORD": "mariposita123!",
        "HOST": "database.cxyjyshr2khi.us-east-1.rds.amazonaws.com",
        "PORT": "5432",
}
}
